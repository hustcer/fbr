...
| P1 correctness            | Decoder must return output or `FbrError`, not panic, on fuzz inputs                   | Checked-in decoder corpus and generated deterministic corpus pass through `tools/brotli/fuzz/run.nu`                                                             | Release-ready locally                                                 |
